...
AppException::AppException(	const std::string& prog_name, \
	...
	std::runtime_error(TAB_ + prog_name + ERROR_ + err_message)
{}

AppException::AppException(	const std::string& prog_name, \
							const std::string& err_message, \
							const std::string& token) :
	std::runtime_error(TAB_ + prog_name + ERROR_ + err_message + ": " + token)
{}
...
AppException::AppException(	const std::string& prog_name, \
	...
	std::runtime_error(TAB_ + prog_name + ERROR_ + TAB_ + \
						err_message + \
