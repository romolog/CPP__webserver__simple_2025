...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   exec_AppRun_20_assemlbe_chunk_or_unchunk.cpp       :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
...
void	AppRun::assemble_chunk_or_unchunk(	Handler* handler_ptr, \
											...
											const std::string& content_type)
{
	...
	if (response.is_head_)
		body.clear();

	if (body.empty())
	{
		std::string content_len = "CONTENT-LENGTH: 0\r\n";
		response.response_str_ = status_line + content_type + content_len + RCLF_;
	}
