...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   exec_AppRun_50_prepare_response.cpp                :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
...
void	AppRun::prepare_response(void)
{
	...
	t_socketfd_handler_map::iterator it = app_handlers_prepare_response_.begin();
	t_socketfd_handler_map::iterator it_dup = it;
	t_socketfd_handler_map::iterator it_end = app_handlers_prepare_response_.end();
